package com.eyck.fxchat.controller.adapter;
...
public class InviteAdapter extends BaseAdapter{
    ...
    private InvitationInfo invationInfo;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (user != null) {// 联系人
            ...
            // 原因
            if (invationInfo.getStatus() == InvitationInfo.InvitationStatus.NEW_INVITE) {// 新的邀请
            ...
            } else if (invationInfo.getStatus() == InvitationInfo.InvitationStatus.INVITE_ACCEPT) {// 接受邀请
            ...
            } else if (invationInfo.getStatus() == InvitationInfo.InvitationStatus.INVITE_ACCEPT_BY_PEER) {// 邀请被接受
                if (invationInfo.getReason() == null) {
    ...
    public interface OnInviteListener {
        // 联系人接受按钮的点击事件
        void onAccept(InvitationInfo invationInfo);

        // 联系人拒绝按钮的点击事件
        void onReject(InvitationInfo invationInfo);
